...
export async function POST(request: Request): Promise<NextResponse> {
  ...
  const productConfig = getProductConfig('studioAnnual')
  ...
  try {
    ...
    await createBillingCheckoutSession({
      ...
      productType: 'studio' as any, // studio annual is a studio subscription
    ...
    console.error('Studio Annual checkout error:', error)
    return NextResponse.json(
      {
        ok: false,
