 ...
 *
 *  `settledMessage` is what the status line says once the stream is playing.
 *  The feed passes nothing and the line goes away; a channel room keeps its
 *  caption, so the bar stays put and only the words change. */
export function ChannelStream({
  ...
  const line = settled ? settledMessage : message
